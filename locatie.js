...
function load(){
    ...
    function changeColor(){
        ...
        document.getElementById("enr6").style.color = "white";
        document.getElementById("enr7").style.color = "white";
        document.getElementById("enr8").style.color = "white";
        ...
        document.getElementById("enr6").style.fontSize = "x-large";
        document.getElementById("enr7").style.fontSize = "x-large";
        document.getElementById("enr8").style.fontSize = "x-large";
    }
}